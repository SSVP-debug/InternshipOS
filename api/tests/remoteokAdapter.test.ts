...
describe("parseRemoteOkListings", () => {
  ...
  // RemoteOK never publishes an application deadline, and this adapter
  // deliberately hard-codes deadline_date: null rather than inferring
  // one from date/epoch or any other field. This test exists to catch
  // an accidental future regression — it was previously only implied by
  // the broader shape-mapping test above, never asserted on its own.
